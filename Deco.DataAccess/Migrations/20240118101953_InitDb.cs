...
namespace Deco.DataAccess.Migrations
{
    ...
    public partial class InitDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "Description", "Name", "Price", "SetPrice" },
                values: new object[,]
                {
                    { 1, 1, "Drawn by Van Goh", "Stary Night", 55000.0, 45000.0 },
                    { 2, 1, "Famous screaming person", "Scream", 65000.0, 55000.0 },
                    { 3, 2, "Fox fur carpet 8*5M", "Fox fur 8*5", 3500.0, 3000.0 },
                    { 4, 2, "Bear fur carpet 9*10M", "Bear fur 9*10", 5000.0, 4000.0 },
                    { 5, 3, "White Cabinet 170*40*70", "Tall White Cab170", 6000.0, 5000.0 },
                    { 6, 3, "Dark Cabinet 45*40*70", "Short Dark Cab45", 2000.0, 1000.0 }
                });
